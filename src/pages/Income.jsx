...
function Income() {
  ...
  // Format date for chart (short format like "30th Sep")
  ...
  // Prepare chart data - show last 5-6 transactions (individual, not grouped)
  const chartData = incomeTransactions
    .slice(0, 6) // Get last 6 transactions
    .map((transaction) => ({
